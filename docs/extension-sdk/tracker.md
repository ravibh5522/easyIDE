...
| First-party packs shipped as extensions (Python, themes) | in-progress | built-ins load through the package reader: `easyide.core-snippets`, `easyide.git-commands`; Python pack and themes not yet |
