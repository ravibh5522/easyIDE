...
| `appearance.density` | auto, dense, comfortable, spacious (`compact` still reads as `dense`) | auto | G | auto is dense on MEDIUM and EXPANDED and comfortable on COMPACT ([density.md](density.md) 2); spacing 0.85 / 1 / 1.2 (snapped to the 2dp half step); rows 28 / 36 / 44, section headers 26 / 32 / 38, tabs 34 / 40 / 44, status 24 / 28 / 32, fields and buttons 30 / 40 / 44, type 13 12 11 / 14 13 12 / 15 14 13; panel default widths 260 / 280 / 300 | `Metrics`, `Kit.text` |
