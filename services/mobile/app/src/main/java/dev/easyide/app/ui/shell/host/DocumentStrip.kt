 ...
 * with unsaved changes says so in the close button's name. A tab is `tabHeight` tall and its cross
 * a `hitBox` square; the touch region beyond that is the theme's touch floor.
 */
@Composable
fun DocumentStrip(
    group: EditorGroup,
