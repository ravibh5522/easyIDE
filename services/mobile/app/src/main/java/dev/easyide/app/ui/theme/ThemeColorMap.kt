...
object ThemeColorMap {
    ...
    val BY_VSCODE_KEY: Map<String, ColorToken> = linkedMapOf(
        ...
        "editorBracketMatch.border" to ColorToken.BRACKET_MATCH_BORDER,
        "editor.lineHighlightBorder" to ColorToken.CURRENT_LINE_BORDER,
        "scrollbarSlider.background" to ColorToken.SCROLLBAR_SLIDER,
        "editorIndentGuide.background1" to ColorToken.INDENT_GUIDE,
        "editorIndentGuide.background" to ColorToken.INDENT_GUIDE,
        ...
        "editor.findMatchBorder" to ColorToken.SEARCH_MATCH_CURRENT_BORDER,
